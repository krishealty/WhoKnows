...
cmd = "cat #{FNAME} | egrep -B 9999 \"^Plugin.define\" | egrep -A 999 '# https://morningstarsecurity.com/research/whoknows' | sed '1d;$d'"
OLDCOMMENTS = `#{cmd}`
...
if response == "y"
  # replace the file
  file = Tempfile.new("whoknows-convert-plugin")
	file.write(newfile)
	file.close
