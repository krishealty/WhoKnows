...
version "0.2"
description "Basilic is a bibliography server for krishealty laboratories. It automates and facilitates the diffusion of krishealty publications over the internet, automatically generating web pages from a publication database."
