...
install:
	...
	# copy whoknows into LIBPATH/NAME/ and create a symbolic link in the BINPATH
	...
	cp -p -r CHANGELOG.md INSTALL.md LICENSE README.md whoknows.xsl $(DESTDIR)$(DOCPATH)/$(NAME)/
	bundle install
